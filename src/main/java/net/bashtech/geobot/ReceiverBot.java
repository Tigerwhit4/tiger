            ...
            if (msg.length > 1) 
                {
                    String throwMessage = "";
                    {
                        for (int i = 1; i < msg.length; i++) 
                            {
                	            if (!sender.equalsIgnoreCase("alefnull") && !sender.equalsIgnoreCase("endsgamer") &&
                	            		(msg[i].toLowerCase().contains("alef") || msg[i].toLowerCase().contains("aief") || 
                	            				msg[i].toLowerCase().contains("ends")))
                                {
                		            throwMessage += sender+" ";
                	            }
                	        else
